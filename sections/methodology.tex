...
\begin{proof}[Proof of Theorem~\ref{thm:stability_cn}]
  ...
  \begin{align*}
    ...
    \xi^\star               & = \frac{1 + ka + r(\cos\beta - 1)}{1 - r(\cos\beta - 1)} \xi^n                                                                                  \\
  \end{align*}
 ...
 Substituting \(\sigma = r(\cos\beta - 1)\) and \(\alpha = ka\) for simplicity, the amplification factor between each step becomes
  ...
  \begin{align*}
    ...
    - \frac{ka}{2} \xi^n                 \\
    \xi^{n+1}               & =
    \left(1 + \frac{ka}{2}\right)
    \left(\frac{1 + ka + r(\cos\beta - 1)}{1 - r(\cos\beta - 1)}\right)\xi^n
    - \frac{ka}{2} \xi^n                 \\
    \frac{\xi^{n+1}}{\xi^n} & =
    -\frac{a^2k^2 + 2(a k + 1) (r (\cos\beta - 1) + 1)}
    {2 (r (\cos\beta - 1) - 1)} \tag{Source: Trust me bro}           \\
  \end{align*}

 
  \[
    \xi = -\frac{\alpha^2 + 2(\alpha + 1)(\sigma + 1)}{2(\sigma - 1)}
  \]
  ...
  \begin{align*}
    \norm*{\xi}                                                         & \leq 1 + Ck                                                                                                                                                       \\
    \norm*{-\frac{\alpha^2 + 2(\alpha + 1)(\sigma + 1)}{2(\sigma - 1)}} & = \norm*{\frac{\alpha^2 + 2(\alpha + 1)(\sigma + 1)}{2(\sigma - 1)}}                                                                                              \\
                                                                        & \leq \norm*{\frac{\alpha^2}{2(\sigma - 1)}} + \norm*{\frac{(\alpha + 1)(\sigma + 1)}{2(\sigma - 1)}}                                                              \\
                                                                        & \leq \frac{\alpha^2}{2\underbrace{\abs{\sigma - 1}}_{\geq 1}} + \frac{(\alpha + 1)\overbrace{\abs{\sigma + 1}}^{\leq 1}}{2\underbrace{\abs{\sigma - 1}}_{\geq 1}} \\
  \end{align*}
\end{proof}
